...
<head>
    ...
    <script type="text/javascript" src="/scripts/business/bill/bill-good-edit.js"></script>
    <title>销量管理平台</title>
</head>
<body ng-app="channelApp">
<div class="pd-20" ng-controller="bill-good-edit">
    <div class="pd-20">
        <form method="post" class="form form-horizontal" id="form-admin-add">
            ...
            <div class="row c1">
                ...
                <div class="formControls col-5">
                    <input class="input-text" value=""
                           ng-model="form.price" width="500">
                </div>
                <div class="col-4"></div>
            </div>
            <div class="row cl">
                <label class="form-label col-3"><span class="c-red">*</span>起始地：</label>

                <div class="formControls col-5">
                    <input class="input-text" value=""
                           ng-model="form.fromArea" width="500">
                </div>
                <div class="col-4"></div>
            </div>
            <div class="row cl">
                <label class="form-label col-3"><span class="c-red">*</span>目的地：</label>

                <div class="formControls col-5">
                    <input class="input-text" value=""
                           ng-model="form.toArea" width="500">
                </div>
                <div class="col-4"></div>
            </div>
            <div class="row cl">
