...
<head>
    ...
    <script type="text/javascript" src="/scripts/business/fund-company.js"></script>
    <title>销量管理平台</title>
</head>
<body ng-app="channelApp">
<div class="pd-20" ng-controller="fund-company">
    <div class="">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"> <a href="javascript:;"
                                                                onclick="consumer_add('添加基金公司','/fund-company/create/init','800','500')"
