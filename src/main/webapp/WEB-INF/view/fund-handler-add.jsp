...
<head>
    ...
    <script type="text/javascript" src="/scripts/business/fund/fund-handler-add.js"></script>
    <title>销量管理平台</title>
</head>
<body ng-app="channelApp">
<div class="pd-20" ng-controller="fund-handler-add">
    <div class="pd-20">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    ...
                    <select name="business" class="select" ng-model="form.fundCompany.id">
                        ...
                        <option ng-repeat="option in fundCompanys" value="{{option.id}}">{{option.fundCompanyName}}</option>
                    </select>
                    </span>
                </div>
            </div>
