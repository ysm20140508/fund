...
<head>
    ...
    <script type="text/javascript" src="/scripts/business/fund/fund-handler-edit.js"></script>
    <title>销量管理平台</title>
</head>
<body ng-app="channelApp">
<div class="pd-20" ng-controller="fund-handler-edit">
    <div class="pd-20">
        <form method="post" class="form form-horizontal" id="form-admin-add">
            ...
            <div class="row cl">
                <label class="form-label col-3"><span class="c-red">*</span>基金经理人代码：</label>

                <div class="formControls col-5">
                    <input class="input-text" value=""
                           ng-model="form.fundHandlerCode" width="500">
                </div>
                <div class="col-4"></div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    ...
                    <select name="business" class="select" ng-model="form.fundCompany.id">
                        ...
                        <option ng-repeat="option in fundCompanys" ng-selected="form.fundCompany.id==option.id"
                                value="{{option.id}}">{{option.fundCompanyName}}
                        </option>
                    </select>
                    </span>
                </div>
