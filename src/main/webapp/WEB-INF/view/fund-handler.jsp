...
<head>
    ...
    <script type="text/javascript" src="/scripts/business/fund/fund-handler.js"></script>
    <title>销量管理平台</title>
</head>
<body ng-app="channelApp">
<div class="pd-20" ng-controller="fund-handler">
    <div class="">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"> <a href="javascript:;"
                                                                onclick="consumer_add('添加基金经理人','/fund-handler/create/init','800','500')"
                                                                class="btn btn-primary radius"><i class="Hui-iconfont">
        &#xe600;</i> 添加基金经理人</a></span></div>
            ...
            <td class="td-manage">
                ...
                <c:if test="${null != operate && operate.delete == 1}">
                    <a title="" target="_blank"
                       href='http://fund.eastmoney.com/f10/jjjl_{{p.fundHandlerCode}}.html'
                       class="ml-5"
