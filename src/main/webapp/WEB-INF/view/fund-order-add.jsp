...
<head>
    ...
    <script type="text/javascript" src="/scripts/business/fund/fund-order-add.js"></script>
    <title>销量管理平台</title>
</head>
<body ng-app="channelApp">
<div class="pd-20" ng-controller="fund-order-add">
    <div class="pd-20">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    ...
                    <select name="business" class="select" ng-model="form.fund.code">
                        ...
                        <option ng-repeat="option in funds" value="{{option.code}}">{{option.name}}</option>
                    </select>
                    </span>
                </div>
            </div>
