...
<div class="pd-20" ng-controller="resource">
    ...
    <form method="post" class="form form-horizontal" id="form-admin-add" ng-submit="edit()">
        ...
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>资源编号:</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder="" id="resource-id" name="resource-id"
                       ng-model="currentResource.id"
                       datatype="*1-50" nullmsg="资源编号不能为空" ng-required="true" ng-readonly="true">
            </div>
            <div class="col-4"></div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
				...
				<select class="select"
                        ng-model="currentResource.parent.id">
                    <option value="" ng-selected="currentResource.parent.id == null">---请选择上级资源---</option>
                    <option ng-repeat="option in parentResources"
                            value="{{option.id}}" ng-selected="currentResource.parent.id == option.id">
                        {{option.name}}
                    </option>
                </select>
				</span>
...
<script type="text/javascript" src="/scripts/custom/resource-edit.js"></script>
</html>
