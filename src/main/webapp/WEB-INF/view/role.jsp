...
<head>
    ...
    <script type="text/javascript" src="/scripts/custom/role.js"></script>
    <title>销量管理平台</title>
</head>
<body ng-app="channelApp">
<div class="pd-20" ng-controller="role">
    <div class="">
    ...
    <c:if test="${null != operate && operate.create == 1}">
        ...
        <a href="javascript:;" onclick="admin_add('添加角色','/role/create/init','800','500')"
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tbody>
        <tr class="text-c" ng-repeat="role in roles">
            <td>{{role.id}}</td>
            <td>{{role.name}}</td>
