...
channelApp.controller('fund-handler-edit', ['$scope', '$http', '$location', function ($scope, $http, $location) {
    $scope.result = null;
    $scope.form = null;
    ...
    $scope.edit = function () {
        $http.post('/fund-handler/edit', angular.toJson($scope.form))
    ...
    $scope.find = function () {
        ...
        $http.get('/fund-handler/find?id=' + id.value)
            .success(function (data) {
                $scope.form = data;
